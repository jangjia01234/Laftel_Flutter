...
class _SingleVideoPlayerState extends State<SingleVideoPlayer> {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        SizedBox(height: _isFullScreen ? 0 : 20),
        Stack(
          children: [
            Positioned(
                child: SizedBox(
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      IconButton(
                        iconSize: 24,
                        icon:
                            Icon(Icons.forward_5_rounded, color: Colors.white),
                        onPressed: () {
                          seekTo(5);
                        },
                      ),
